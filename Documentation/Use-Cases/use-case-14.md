# USE CASE: 14. Report showing top x populated cities in a region
...
### Trigger
User prompts application for population data of a user specified number of cities in a region.
