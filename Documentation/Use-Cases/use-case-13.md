# USE CASE: 13. Report showing top x populated cities in a continent
...
### Trigger
Data Analyst prompts application for population data of a specified number of cities in a continent.
