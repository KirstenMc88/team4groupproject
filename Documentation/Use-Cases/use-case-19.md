# USE CASE: 19. Report showing all capital cities in a region
...
### Trigger
Data Analyst prompts application for the population data of all capital cities in a specified region.
