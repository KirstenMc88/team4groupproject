# USE CASE: 20. Report showing top x populated capital cities in the world
...
### Trigger
Data Analyst prompts application for population data of a specified number of capital cities in the world.
