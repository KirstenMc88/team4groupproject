# USE CASE: 16. Report showing top x populated cities in a district
...
### Trigger
Data Analyst prompts application for population data of a specified number of cities in a district.
