# USE CASE: 21. Report showing top x populated capital cities in a continent
...
### Trigger
Data Analyst prompts application for population data of a specified number of capital cities in a continent.
