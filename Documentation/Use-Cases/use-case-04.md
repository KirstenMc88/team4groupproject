# USE CASE: 4. Report showing top x populated countries in the world
...
### Trigger
User prompts application for population data of a user specified number of countries in the world.
