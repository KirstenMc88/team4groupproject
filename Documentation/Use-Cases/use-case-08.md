# USE CASE: 8. Report showing all cities in a continent
...
### Trigger
Data Analyst prompts application for the data on the population of all the cities in a specified continent.
