# USE CASE: 22. Report showing top x populated capital cities in a region
...
### Trigger
Data Analyst prompts application for population data of a specified number of capital cities in a region.
