# USE CASE:  15. Report showing top x populated cities in a country
...
### Trigger
Data Analyst prompts application for population data of a specified number of cities in a country.
