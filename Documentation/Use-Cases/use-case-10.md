# USE CASE: 10. Report showing all cities in a country
...
### Trigger
Data Analyst prompts application for the data on the population of all the cities in a specified country.
